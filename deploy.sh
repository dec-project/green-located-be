...
Web_driver_path="/Users/sanggyun/Downloads/chromedriver-mac-arm64"
Web_driver_headless_path="/Users/sanggyun/Downloads/chrome-headless-shell-linux64"
...
#scp -i "$PEM_FILE" -r "$Web_driver_path" $EC2_USER@$EC2_HOST:$TARGET_DIR
#scp -i "$PEM_FILE" -r "$Web_driver_headless_path" $EC2_USER@$EC2_HOST:$TARGET_DIR
